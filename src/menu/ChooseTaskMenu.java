...
public class ChooseTaskMenu implements Menu {
    public Menu prevMenu;
    public Project project;

    ChooseTaskMenu(Menu prevMenu, Project project) {
    ...
    public Menu display() {
        ...
        if(choice <= project.getTasks().size() && choice > 0)
        {
            return new EditTaskMenu(prevMenu, project, project.getTasks().get(choice - 1));
        }
        else {
